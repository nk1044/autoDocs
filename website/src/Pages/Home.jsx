    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-neutral-900 text-neutral-300 px-6">
      ...
      <div className="max-w-3xl text-center my-16">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <a href="https://github.com/nk1044/autoDocs" target="_blank" rel="noopener noreferrer" className="bg-transparent hover:bg-neutral-800 text-neutral-300 border border-neutral-700 px-6 py-3 rounded-md font-medium transition">Explore Github Repository</a>
        </div>
      </div>
      ...
      <div id="contribute" className="w-full max-w-6xl mx-auto py-16 border-t border-neutral-800">
        <h2 className="text-3xl font-bold text-white text-center mb-12">Contribute to autoDocs</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <div className="flex justify-center space-x-4 mb-6">
                <a href="https://github.com/nk1044/autoDocs" target="_blank" rel="noopener noreferrer" className="bg-neutral-700 hover:bg-neutral-600 text-white px-6 py-3 rounded-md font-medium transition flex items-center">
              ...
              <div className="bg-neutral-900 p-4 rounded-md border overflow-auto border-neutral-700 font-mono text-sm text-neutral-400">
                <div className="mb-2">$ git clone https://github.com/nk1044/autoDocs.git</div>
                <div className="mb-2">$ cd autoDocs</div>
