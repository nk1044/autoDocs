...
function Header({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div className='w-full pt-2'>
      <div className='flex items-center justify-between bg-neutral-800 p-3 rounded-lg border-b border-neutral-700 shadow-sm'>

        {/* Left side: Logo + Menu for mobile */}
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <h1 className='text-2xl font-bold text-white pt-1'>autoDocs</h1>
          </div>
        </div>
